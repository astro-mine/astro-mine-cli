...
class _Command:
    """`astro-mine sim <verb>` — run and record simulated episodes."""

    name = "sim"
    help = "run and record simulated episodes"
    ...
    def run(self, args: argparse.Namespace) -> int:
        ...
        # keeps working -- is deliberately NOT reproduced here. That contract belongs to the
        # module Cloud actually invokes; on this surface the verb is always typed.
        try:
